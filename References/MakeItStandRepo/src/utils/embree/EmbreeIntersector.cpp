...
bool EmbreeIntersector::intersectRay(const RowVector3& origin, const RowVector3& direction, embree::Hit &hit) const
{
...
bool EmbreeIntersector::intersectSegment(const RowVector3& a, const RowVector3& ab, embree::Hit &hit) const
{
